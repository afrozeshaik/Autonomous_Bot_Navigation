...
#     - insert line following routines (IR & camera)
...
if __name__ == "__main__":
    ...
    while next_action != 'STOP':
        ...
        list_width = []
        list_speed = []
        # ----------------------------------------------------------------------------- Determine pan-correction
        #pan_adjust = 1.0 * ((90.0 - pan_angle) * ( w / 640.000)* 50)
        #pan_adjust = round (pan_adjust, 1)
        #print'pan adjustment ......................=', pan_adjust
        pan_angle = 90
        speed_adjust = 0.0
        w_save = w - 1
        bot.set_neck_angles( pan_angle,tilt_angle)
        ...
        print'width / range / pan / speed .........= %d / %d / %d ' % (w, camera_range, speed_adjust)
        # -----------------------------------------------------------------------------
